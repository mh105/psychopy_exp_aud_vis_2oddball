...
expName = 'visual_oddball_2ob_letter'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/alexhe/Library/CloudStorage/Dropbox/Active_projects/PsychoPy/exp_aud_vis_2oddball/visual_oddball_2ob_letter.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    task_start_code = 100
    # special code 113 (task ID for visual double letter oddball P300 task)
    task_ID_code = 113
    print("Starting experiment: < Visual Double Letter Oddball Task >. Task ID:", task_ID_code)
    ...
    STIMULI = {
        "regular":   {"size": 0.3, "text": "Q"},
        "oddball":    {"size": 0.3, "text": "O"}, #0.5
        "distractor": {"size": 0.3, "text": "X"},
    }
    ...
    for _ in range(N_CHUNKS):
        inner = (
            [("regular",   STIMULI["regular"]["text"],   STIMULI["regular"]["size"])]   * 7
          + [("oddball",    STIMULI["oddball"]["text"],    STIMULI["oddball"]["size"])]     * 1
          + [("distractor", STIMULI["distractor"]["text"], STIMULI["distractor"]["size"])] * 1
        )
        np.random.shuffle(inner)  # shuffles all three fields together — sizes stay aligned
    
        chunk = [("regular", STIMULI["regular"]["text"], STIMULI["regular"]["size"])] + inner
    
        types, text, sizes = zip(*chunk)
        trial_types  += list(types)
        trial_text  += list(text)
    ...
    text_fixation_oddball = visual.TextStim(win=win, name='text_fixation_oddball',
        ...
        languageStyle='LTR',
        depth=0.0);
    text_oddball_ = visual.TextStim(win=win, name='text_oddball_',
        text=STIMULI["oddball"]["text"],
        font='Arial',
    ...
    text_fixation_regular = visual.TextStim(win=win, name='text_fixation_regular',
        ...
        languageStyle='LTR',
        depth=0.0);
    text_regular_ = visual.TextStim(win=win, name='text_regular_',
        text=STIMULI["regular"]["text"],
        font='Arial',
        pos=(0, 0), draggable=False, height=0.15, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
    ...
    text_fixation_distractor = visual.TextStim(win=win, name='text_fixation_distractor',
        ...
        languageStyle='LTR',
        depth=0.0);
    text_distractor_ = visual.TextStim(win=win, name='text_distractor_',
        text=STIMULI["distractor"]["text"],
        font='Arial',
        pos=(0, 0), draggable=False, height=0.15, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
    ...
    text_fixation_combined = visual.TextStim(win=win, name='text_fixation_combined',
        ...
        languageStyle='LTR',
        depth=0.0);
    text_oddball_combined = visual.TextStim(win=win, name='text_oddball_combined',
        text=STIMULI["oddball"]["text"],
        font='Arial',
        ...
        languageStyle='LTR',
        depth=-1.0);
    text_regular_combined = visual.TextStim(win=win, name='text_regular_combined',
        text=STIMULI["regular"]["text"],
        font='Arial',
        pos=(0, 0), draggable=False, height=0.05, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
        depth=-2.0);
    text_distractor_combined = visual.TextStim(win=win, name='text_distractor_combined',
        text=STIMULI["distractor"]["text"],
        font='Arial',
        pos=(0, 0), draggable=False, height=0.05, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
    ...
    shape_oddball = data.Routine(
        name='shape_oddball',
        components=[text_fixation_oddball, text_oddball_],
    )
    ...
    while continueRoutine:
        ...
        if text_fixation_oddball.status == STARTED:
            ...
            if tThisFlipGlobal > text_fixation_oddball.tStartRefresh + 0.5-frameTolerance:
                # keep track of stop time/frame for later
        ...
        # *text_oddball_* updates
        
        # if text_oddball_ is starting this frame...
        if text_oddball_.status == NOT_STARTED and tThisFlip >= 0.5-frameTolerance:
            # keep track of start time/frame for later
            text_oddball_.frameNStart = frameN  # exact frame index
            text_oddball_.tStart = t  # local t and not account for scr refresh
            text_oddball_.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(text_oddball_, 'tStartRefresh')  # time at next scr refresh
            # add timestamp to datafile
            thisExp.timestampOnFlip(win, 'text_oddball_.started')
            # update status
            text_oddball_.status = STARTED
            text_oddball_.setAutoDraw(True)
        
        # if text_oddball_ is active this frame...
        if text_oddball_.status == STARTED:
            # update params
            pass
        
        # if text_oddball_ is stopping this frame...
        if text_oddball_.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > text_oddball_.tStartRefresh + STIMULUS_DURATION-frameTolerance:
                # keep track of stop time/frame for later
                text_oddball_.tStop = t  # not accounting for scr refresh
                text_oddball_.tStopRefresh = tThisFlipGlobal  # on global time
                text_oddball_.frameNStop = frameN  # exact frame index
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'text_oddball_.stopped')
                # update status
                text_oddball_.status = FINISHED
                text_oddball_.setAutoDraw(False)
    ...
    shape_regular = data.Routine(
        name='shape_regular',
        components=[text_fixation_regular, text_regular_],
    )
    ...
    while continueRoutine:
        ...
        if text_fixation_regular.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > text_fixation_regular.tStartRefresh + 0.5-frameTolerance:
                # keep track of stop time/frame for later
        ...
        # *text_regular_* updates
        
        # if text_regular_ is starting this frame...
        if text_regular_.status == NOT_STARTED and tThisFlip >= 0.5-frameTolerance:
            # keep track of start time/frame for later
            text_regular_.frameNStart = frameN  # exact frame index
            text_regular_.tStart = t  # local t and not account for scr refresh
            text_regular_.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(text_regular_, 'tStartRefresh')  # time at next scr refresh
            # add timestamp to datafile
            thisExp.timestampOnFlip(win, 'text_regular_.started')
            # update status
            text_regular_.status = STARTED
            text_regular_.setAutoDraw(True)
        
        # if text_regular_ is active this frame...
        if text_regular_.status == STARTED:
            # update params
            pass
        
        # if text_regular_ is stopping this frame...
        if text_regular_.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > text_regular_.tStartRefresh + STIMULUS_DURATION-frameTolerance:
                # keep track of stop time/frame for later
                text_regular_.tStop = t  # not accounting for scr refresh
                text_regular_.tStopRefresh = tThisFlipGlobal  # on global time
                text_regular_.frameNStop = frameN  # exact frame index
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'text_regular_.stopped')
                # update status
                text_regular_.status = FINISHED
                text_regular_.setAutoDraw(False)
    ...
    shape_distractor = data.Routine(
        ...
        components=[text_fixation_distractor, text_distractor_],
    )
    ...
    while continueRoutine:
        ...
        if text_fixation_distractor.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > text_fixation_distractor.tStartRefresh + 0.5-frameTolerance:
                # keep track of stop time/frame for later
        ...
        # *text_distractor_* updates
        
        # if text_distractor_ is starting this frame...
        if text_distractor_.status == NOT_STARTED and tThisFlip >= 0.5-frameTolerance:
            # keep track of start time/frame for later
            text_distractor_.frameNStart = frameN  # exact frame index
            text_distractor_.tStart = t  # local t and not account for scr refresh
            text_distractor_.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(text_distractor_, 'tStartRefresh')  # time at next scr refresh
            # add timestamp to datafile
            thisExp.timestampOnFlip(win, 'text_distractor_.started')
            # update status
            text_distractor_.status = STARTED
            text_distractor_.setAutoDraw(True)
        
        # if text_distractor_ is active this frame...
        if text_distractor_.status == STARTED:
            # update params
            pass
        
        # if text_distractor_ is stopping this frame...
        if text_distractor_.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > text_distractor_.tStartRefresh + STIMULUS_DURATION-frameTolerance:
                # keep track of stop time/frame for later
                text_distractor_.tStop = t  # not accounting for scr refresh
                text_distractor_.tStopRefresh = tThisFlipGlobal  # on global time
                text_distractor_.frameNStop = frameN  # exact frame index
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'text_distractor_.stopped')
                # update status
                text_distractor_.status = FINISHED
                text_distractor_.setAutoDraw(False)
    ...
    for thisPractice_loop in practice_loop:
        ...
        shape_combined = data.Routine(
            name='shape_combined',
            components=[text_fixation_combined, text_oddball_combined, text_regular_combined, text_distractor_combined],
        )
        ...
        while continueRoutine:
            ...
            # *text_oddball_combined* updates
            
            # if text_oddball_combined is starting this frame...
            if text_oddball_combined.status == NOT_STARTED and tThisFlip >= 0.5-frameTolerance:
                # keep track of start time/frame for later
                text_oddball_combined.frameNStart = frameN  # exact frame index
                text_oddball_combined.tStart = t  # local t and not account for scr refresh
                text_oddball_combined.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(text_oddball_combined, 'tStartRefresh')  # time at next scr refresh
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'text_oddball_combined.started')
                # update status
                text_oddball_combined.status = STARTED
                text_oddball_combined.setAutoDraw(True)
            
            # if text_oddball_combined is active this frame...
            if text_oddball_combined.status == STARTED:
                # update params
                pass
            
            # if text_oddball_combined is stopping this frame...
            if text_oddball_combined.status == STARTED:
                # is it time to stop? (based on global clock, using actual start)
                if tThisFlipGlobal > text_oddball_combined.tStartRefresh + STIMULUS_DURATION-frameTolerance:
                    # keep track of stop time/frame for later
                    text_oddball_combined.tStop = t  # not accounting for scr refresh
                    text_oddball_combined.tStopRefresh = tThisFlipGlobal  # on global time
                    text_oddball_combined.frameNStop = frameN  # exact frame index
                    # add timestamp to datafile
                    thisExp.timestampOnFlip(win, 'text_oddball_combined.stopped')
                    # update status
                    text_oddball_combined.status = FINISHED
                    text_oddball_combined.setAutoDraw(False)
            
            # *text_regular_combined* updates
            
            # if text_regular_combined is starting this frame...
            if text_regular_combined.status == NOT_STARTED and tThisFlip >= 1.7-frameTolerance:
                # keep track of start time/frame for later
                text_regular_combined.frameNStart = frameN  # exact frame index
                text_regular_combined.tStart = t  # local t and not account for scr refresh
                text_regular_combined.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(text_regular_combined, 'tStartRefresh')  # time at next scr refresh
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'text_regular_combined.started')
                # update status
                text_regular_combined.status = STARTED
                text_regular_combined.setAutoDraw(True)
            
            # if text_regular_combined is active this frame...
            if text_regular_combined.status == STARTED:
                # update params
                pass
            
            # if text_regular_combined is stopping this frame...
            if text_regular_combined.status == STARTED:
                # is it time to stop? (based on global clock, using actual start)
                if tThisFlipGlobal > text_regular_combined.tStartRefresh + 0.5-frameTolerance:
                    # keep track of stop time/frame for later
                    text_regular_combined.tStop = t  # not accounting for scr refresh
                    text_regular_combined.tStopRefresh = tThisFlipGlobal  # on global time
                    text_regular_combined.frameNStop = frameN  # exact frame index
                    # add timestamp to datafile
                    thisExp.timestampOnFlip(win, 'text_regular_combined.stopped')
                    # update status
                    text_regular_combined.status = FINISHED
                    text_regular_combined.setAutoDraw(False)
            
            # *text_distractor_combined* updates
            
            # if text_distractor_combined is starting this frame...
            if text_distractor_combined.status == NOT_STARTED and tThisFlip >= 2.9-frameTolerance:
                # keep track of start time/frame for later
                text_distractor_combined.frameNStart = frameN  # exact frame index
                text_distractor_combined.tStart = t  # local t and not account for scr refresh
                text_distractor_combined.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(text_distractor_combined, 'tStartRefresh')  # time at next scr refresh
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'text_distractor_combined.started')
                # update status
                text_distractor_combined.status = STARTED
                text_distractor_combined.setAutoDraw(True)
            
            # if text_distractor_combined is active this frame...
            if text_distractor_combined.status == STARTED:
                # update params
                pass
            
            # if text_distractor_combined is stopping this frame...
            if text_distractor_combined.status == STARTED:
                # is it time to stop? (based on global clock, using actual start)
                if tThisFlipGlobal > text_distractor_combined.tStartRefresh + STIMULUS_DURATION-frameTolerance:
                    # keep track of stop time/frame for later
                    text_distractor_combined.tStop = t  # not accounting for scr refresh
                    text_distractor_combined.tStopRefresh = tThisFlipGlobal  # on global time
                    text_distractor_combined.frameNStop = frameN  # exact frame index
                    # add timestamp to datafile
                    thisExp.timestampOnFlip(win, 'text_distractor_combined.stopped')
                    # update status
                    text_distractor_combined.status = FINISHED
                    text_distractor_combined.setAutoDraw(False)
    ...
    for thisTrial in trials:
        ...
        trial = data.Routine(
            name='trial',
            components=[stimulus_text, text_fixation_cross, shape_resp],
        )
        ...
        stimulus_text.setText(shape_text)
        ...
        while continueRoutine:
            ...
            # if stimulus_text is starting this frame...
            if stimulus_text.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                ...
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'stimulus_text.started')
                # update status
                stimulus_text.status = STARTED
                stimulus_text.setAutoDraw(True)
            
            # if stimulus_text is active this frame...
            if stimulus_text.status == STARTED:
                # update params
                pass
            
            # if stimulus_text is stopping this frame...
            if stimulus_text.status == STARTED:
                # is it time to stop? (based on global clock, using actual start)
                if tThisFlipGlobal > stimulus_text.tStartRefresh + STIMULUS_DURATION-frameTolerance:
                    # keep track of stop time/frame for later
                    stimulus_text.tStop = t  # not accounting for scr refresh
                    stimulus_text.tStopRefresh = tThisFlipGlobal  # on global time
                    stimulus_text.frameNStop = frameN  # exact frame index
                    # add timestamp to datafile
                    thisExp.timestampOnFlip(win, 'stimulus_text.stopped')
                    # update status
                    stimulus_text.status = FINISHED
                    stimulus_text.setAutoDraw(False)
            
            # *text_fixation_cross* updates
            
            # if text_fixation_cross is starting this frame...
            if text_fixation_cross.status == NOT_STARTED and tThisFlip >= STIMULUS_DURATION-frameTolerance:
                # keep track of start time/frame for later
            ...
            if stimulus_text.status == STARTED and not pulse_started:
                if shape_is_oddball:
